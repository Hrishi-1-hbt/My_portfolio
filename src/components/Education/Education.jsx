...
import img_education from '../../assets/img_education.jpg';
    ...
    <section id='education' className='relative overflow-hidden flex flex-col text-gray-600 body-font'>
      ...
      <div className='container mx-auto flex px-5 py-24 md:flex-row flex-col items-center'>
        ...
        >
          ...
          <h2 className='title-font font-bold text-white sm:text-2xl'>Post Graduation (MCA):</h2>
          <p className='mb-8 text-white leading-relaxed'>
            Pursuing Master of Computer Applications (MCA) at PES University - Ring Road Campus, Bengaluru.
          </p>

        
          <h2 className='title-font font-bold text-white sm:text-2xl'>Under Graduation (Bsc):</h2>
          <p className='mb-8 text-white leading-relaxed'>
            Completed Bachelor of Science  (BSc) at Sarada Vilas College, Mysore.
          </p>

          
          <h2 className='title-font font-bold text-white sm:text-2xl'>Pre-University College (PUC):</h2>
          <p className='mb-8 text-white leading-relaxed'>
            Completed Pre-University Education in Science (PCMC) at SDMPU College, Ujire.
          </p>
        </div>
      </div>
    </section>
